...
<div class="container mt-5">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white text-center">
            <h2 class="mb-0 text-white">Thông tin cá nhân</h2>
        </div>
        <div class="card-body">
            <form action="{{ route('client.update', $user) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address" class="form-control" style="color: black" id="address" placeholder="Enter your address.." value="{{ $user->address }}">
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">Phone</label>
                    <input type="number" name="phone" class="form-control" style="color: black" id="phone" placeholder="Enter your phone.." value="{{ $user->phone }}">
                </div>
