    ...
    <div class="container-fluid py-3">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                ...
                <p>Chúng tôi luôn cung cấp những sản phẩm thực phẩm tươi ngon, chất lượng cao để đáp ứng nhu cầu của mọi gia đình. Dưới đây là một số sản phẩm bán chạy nhất hiện nay:</p>
            </div>
            <div class="row g-4">
