    ...
    <div  class="d-flex justify-content-between">
        <div class="top-info ps-2">
            <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                    class="text-white">Xuân Phương, Hà Nội</a></small>
            <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                    class="text-white">congmd0504@gmail.com</a></small>
        </div>
    ...
    <nav class="navbar navbar-light bg-white navbar-expand-xl">
        ...
        <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
            <div class="navbar-nav mx-auto">
                <a href="{{route('client.index')}}" class="nav-item nav-link active">Trang Chủ</a>
                    ...
                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                        @foreach ($categories as $category)
                            @if ($category->id == 1)
                                ...
                                @continue
                            @endif
                            <a href="{{route('client.shop.id',$category)}}"
            ...
            <div class="d-flex m-3 me-0">
                ...
                <a href="{{route('client.cart.index')}}" class="position-relative me-4 my-auto">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item ">
                            <a class="nav-link border border-success rounded text-success" href="{{route('getLogin')}}">Đăng nhập</a>
                        </li>
                        <li class="nav-item ms-2">
                            <a class="nav-link border border-danger rounded text-danger" href="{{route('getRegister')}}">Đăng ký</a>
                        </li>
                    @endif
                </ul>
            </div>
