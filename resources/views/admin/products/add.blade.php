...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{ route('admin.products.store') }}" class="m-3" method="POST"
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="quantity" class="fw-bold">Số lượng sản phẩm:</label>
                            ...
                            <div class="col-6">
                                ...
                                <label for="quantity" class="fw-bold">Nhãn :</label>
